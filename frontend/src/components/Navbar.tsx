      ...
      <div className="mx-auto flex min-h-[93px] w-full max-w-[1706px] items-center justify-between px-6 sm:px-10 lg:px-[138px]">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          <Button
            ...
            className="h-auto px-2 py-2 shadow-none hover:bg-transparent text-sm font-semibold leading-5 text-[#003514] hover:text-[#003514]"
          >
            Log In
          </Button>
          <Button
            onClick={() => navigate("/register")}
            className="h-auto rounded-full bg-[#deec5a] px-6 py-3 shadow-[0px_4px_0px_#5b630080] hover:bg-[#d7e652] text-sm font-bold leading-5 text-[#1a1d00]"
          >
            Sign Up
          </Button>
        </div>
