    ...
    <DashboardShell>
      <main className="flex min-h-screen w-full flex-col items-center gap-7 bg-[#f8f9fb] p-0 text-[#191c1e] lg:min-h-[1024px] lg:w-[1024px] lg:grow">
        <section className="flex w-full max-w-6xl flex-col gap-4 px-4 py-5 sm:px-5 lg:px-7">
          ...
          <section className="grid w-full max-w-[946px] gap-4 lg:grid-cols-2">
            <section className="rounded-lg border border-[#e1e2e4] bg-white p-4 shadow-[0px_4px_20px_rgba(3,78,34,0.05)] sm:p-5">
              ...
              <Button
                ...
                className="mt-5 h-10 rounded-full bg-[#d4e251] px-5 text-sm font-semibold text-[#003514] hover:bg-[#cfdc42] disabled:opacity-60"
              >
          ...
          <section className="w-full max-w-[946px] rounded-lg border border-[#e1e2e4] bg-white p-4 shadow-[0px_4px_20px_rgba(3,78,34,0.05)] sm:p-5">
            ...
            <Button
              ...
              className="mt-5 h-10 rounded-full bg-[#fff4de] px-5 text-sm font-semibold text-[#7a4100] hover:bg-[#ffe9c2] hover:text-[#7a4100] disabled:opacity-60"
            >
