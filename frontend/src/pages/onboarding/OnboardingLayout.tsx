...
export const OnboardingLayout = ({ step, children }: OnboardingLayoutProps) => (
  <main className="min-h-screen bg-[#f8f9fb] px-4 py-7 sm:px-5 lg:py-20">
    <section className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-[640px] flex-col items-center justify-center gap-7">
